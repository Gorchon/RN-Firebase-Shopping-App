...
import { deleteDoc, doc, updateDoc, UpdateDoc } from 'firebase/firestore';
import {AntDesign } from '@expo/vector-icons'; 


export default function Product({ //firebase creates an id for each document in a collection. Firebase do it for us.
    id,
    emoji, 
    name, 
    price,
